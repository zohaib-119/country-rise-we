...
const CreateProduct = () => {
  ...
  return (
    ...
    <h2 className="text-3xl font-bold text-blue-600 mb-6 text-center">{translations[language].createProduct}</h2>  
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
            <label htmlFor="images" className="block text-lg font-semibold mb-2">{translations[language].uploadImages}</label>  
            <input
                type="file"
                id="images"
                name="images"
